<?php 
	...
	$Category= $db-> fetchID("thuong_hieu" ,$id);
    ...
    $sql =" SELECT * FROM san_pham WHERE id_ThuongHieu = $id ORDER BY id DESC LIMIT " .($pagenumber - 1) * $pagesize." , $pagesize";
   
    $sqltotal =" SELECT * FROM san_pham WHERE id_ThuongHieu = $id ORDER BY id DESC";
...
<div class="col-sm-9 padding-right">
   <div class="features_items">
      <!--features_items-->
      	<h2 class="title text-center"><?php echo $Category['TenTH'] ?></h2>
