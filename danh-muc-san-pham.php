<?php 
	  ...
	  $Category= $db-> fetchID("danh_muc" ,$id);
  	    
    $pagesize = 12;

    $pagenumber = isset($_GET['page']) ? $_GET['page'] :"1";

    $sql =" SELECT * FROM san_pham WHERE id_DanhMuc = $id ORDER BY id DESC LIMIT " .($pagenumber - 1) * $pagesize." , $pagesize";
   
    $sqltotal =" SELECT * FROM san_pham WHERE id_DanhMuc = $id ORDER BY id DESC";
...
<div class="col-sm-9 padding-right">
   <div class="features_items">
      <!--features_items-->
      	<h2 class="title text-center"><?php echo $Category['TenDM'] ?></h2>
