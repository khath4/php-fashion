<?php 
    ...
    $sqlthuong = "SELECT * FROM don_hang WHERE EXTRACT(YEAR FROM Created_at) = $year AND EXTRACT(MONTH FROM Created_at) = $month AND TrangThai = 3 AND TrangThaiTT = 0 ";
    $thuong = $db -> fetchsql($sqlthuong); 
        ...
        <div class="col-lg-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url(). 'admin/month.php?year='.$year.'' ?>">Thu Nhập Năm <?php echo $year ?> (Thanh Toán Thường)</a></li>
                <li class="breadcrumb-item">Tháng <?php echo $month ?> (Thanh Toán Thường)</li>
              </ol>
            </nav>
            <div class="clearfix">
           <!--  Notification -->
