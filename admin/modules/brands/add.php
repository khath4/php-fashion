<?php
    ...
    $data = [
  	...
  	if($_SERVER["REQUEST_METHOD"] == "POST")
  	{
  		...
  		if(postInput('TenTH') == '') 
  		{
  			$error['TenTH']="Mời bạn nhập tên thương hiệu."; 
  		}
      	if(strlen(postInput('TenTH'))  > 30 ) 
      	{
        	$error['TenTH']="Tên thương hiệu quá dài quá dài."; 
      	}
      	if(postInput('SoTT') == '') 
      	{
      ...
      // else
      // {
      //   $is_check = $db -> fetchOne("brands", "numerical = '".$data['numerical']."' ");
      //   if($is_check != NULL) 
      //   {
  		...
  		if(empty($error)) 
      {
          ...
          if($isset > 0) 
          {
              $_SESSION['error'] = "Tên thương hiệu này đã tồn tại.";
          }
          else
          {
              $id_insert =$db -> insert("thuong_hieu" , $data);
              if($id_insert > 0)
              {
...
<?php require_once __DIR__. "/../../layouts/header.php"; ?>        
    ...
    <div class="container-fluid">
    	<div class="row">
    		<div class="col-md-12">
          <label for="exampleInputEmail1"><h1 class="text-primary">Thêm Mới Thương Hiệu</h1></label>
    			<form  action="" method="POST">

            <div class="form-group row">
              <label for="staticEmail" class="col-sm-4 col-form-label"><b class="text-primary">Số Thứ Tự(*)</b></label>
              <div class="col-sm-12">
                  <input type="number" class="form-control" id="input" placeholder="Thứ tự xắp xếp thương hiệu" name="SoTT" value="<?php echo $data['SoTT'] ?>">
                 <!--  Notification -->
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-12">
                  <input type="text" class="form-control" id="input" placeholder="Tên thương hiệu" name="TenTH" value="<?php echo $data['TenTH'] ?>">
                 <!--  Notification -->
